        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a style="color: black; text-decoration: none;" href="{{ route('show-csv-content', ['fileName' => $file]) }}">{{ $file }}</a>
                        </td>
                        <td>{{ $info['last_opened'] }}</td>
                        <td>
                            <a style="color: black; text-decoration: none;" href="{{ route('deleteFile', ['filename' => $file]) }}">Delete</a>
                            <span style="margin-left: 10px;">
                                <a style="color: black; text-decoration: none;" href="{{ route('download-prepared-csv', ['filename' => $file]) }}">Download</a>
                            </span>
                        </td>
                    </tr>
