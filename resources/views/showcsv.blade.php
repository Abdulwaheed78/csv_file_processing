...
@section('content')
    <div class="content">
            ...
            @if (session('success'))
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        if (messageModal) {
                            // Element exists, proceed with modal logic
                            ...
                            console.error('Element with ID "messageModal" not found.');
                        }
                    });
                </script>
            @endif
        ...
        <div class="container">
            <h3 class="text-primary mb-4">Define New File Include Excludes</h3>
            <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-3" style="overflow: hidden;">
                                    <p class="card-header bg-primary text-white">New Csv File Columns</p>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card " style="overflow: hidden;">
                                    <p class="card-header bg-primary text-white">Filter Csv File By Columns</p>
                                    <div class="card-body">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-check mx-2">
                                    <input type="checkbox" id="myCheckbox" name="myCheckbox" value="checkme"
                                        class="form-check-input" style="border-color: black;">
        ...
        <div class="container mt-3">
            <div class="container mb-3 bg-primary">
                <div class="bulk-actions d-flex align-items-center text-white"> <!-- Add text-white class here -->
                    <span class="mobile-title">
                        <h3>File Details</h3>
                    </span>
                    <span class="mt-3 ml-5" style="margin-left: 10px;">
                        <p>Rows({{ $totalRows }})</p>
                    </span>
                    <span class="mt-3 ml-5" style="margin-left: 20px;">
